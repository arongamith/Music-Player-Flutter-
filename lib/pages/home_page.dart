          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              if (playlistProvider.currentSongIndex == index) {
                trailingIcon = playlistProvider.isPlaying ? Icons.play_circle_outline : Icons.pause_circle_outline;
              }
              ...
              return ListTile(
                ...
                onTap: () {
                  if (playlistProvider.isPlaying && playlistProvider.currentSongIndex == index || playlistProvider.currentDuration.inSeconds > 0 && !playlistProvider.isPlaying){
                    Navigator.push(
                      context, 
                      MaterialPageRoute(
                        builder: (context) => const SongPage(),
